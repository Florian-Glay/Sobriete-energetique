...
export const MobileLayout: React.FC<MobileLayoutProps> = ({ children, bottomNav }) => {
  return (
    <div className="w-full h-[100dvh] bg-white md:min-h-screen md:h-auto md:bg-gray-100 md:p-4 md:flex md:items-center md:justify-center">
      <div className="relative w-full h-full bg-white flex flex-col md:w-[41vh] md:max-w-[400px] md:h-[85vh] md:max-h-[850px] md:min-h-[600px] md:shadow-2xl md:rounded-[40px] md:overflow-hidden md:border-8 md:border-gray-900 md:ring-1 md:ring-gray-900/50">
